...
class ECG:
	...
	def DimensionalReduciton(self,test_final):
		...
		pca_loaded_model = joblib.load('Cardiovascular-Detection-using-ECG-images-main\Deployment\PCA_ECG (1).pkl')
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		loaded_model = joblib.load('Cardiovascular-Detection-using-ECG-images-main\Deployment\Heart_Disease_Prediction_using_ECG (4).pkl')
